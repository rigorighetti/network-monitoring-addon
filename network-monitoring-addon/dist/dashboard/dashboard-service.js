...
class DashboardService {
    constructor(dataStore, configManager, logger, config) {
        ...
        if (!this.config.staticPath) {
            this.config.staticPath = path_1.default.join(__dirname, 'static');
        }
        // Create API server
        const apiConfig = {
        ...
        this.apiServer = new api_server_1.APIServer(this.dataStore, this.configManager, this.logger, apiConfig);
        // Create real-time service
        this.realtimeService = new realtime_service_1.RealtimeService(this.dataStore, this.apiServer, this.logger);
